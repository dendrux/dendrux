  ...
  return (
    <div className="min-h-screen">
      ...
      <header className="px-6 py-5 border-b border-border-soft">
        <h1 className="text-[22px] font-semibold text-text-primary">Dendrite</h1>
        <p className="text-xs text-text-muted mt-0.5">Agent observability dashboard</p>
      </header>

      {/* Active pauses strip */}
      {pausedRuns.length > 0 && (
        <div className="px-6 py-3 bg-state-paused/[0.04] border-b border-state-paused/10">
      ...
      {/* Filters */}
      <div className="px-6 py-3 border-b border-border-soft flex items-center gap-3">
        <FilterSelect
          value={statusFilter}
