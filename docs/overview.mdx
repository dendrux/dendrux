...
The value is durable pause/resume. If your agent never needs to stop and wait for a human, a client-side tool, or to survive a restart mid-run, a thinner library will serve you better. [Is dendrux for you?](/docs/is-dendrux-for-you) is a two-minute self-check, and [How dendrux compares](/docs/how-dendrux-compares) places it next to agent frameworks and durable execution engines.
